...
if __name__ == "__main__":
	...
	vertmotpos = caget("6bma1:m18")  #scale to mm
	print "Inital Motor Position: %6.3f" % (vertmotpos) 
	rotpos = caget("6bma1:m19")

	# original positions
	# vertmotpos is m18-zr
	# vertmotpos is m18-zr
	...
	for x in range(0,numframes_x): 
		...
		caput("6bma1:m19",rotpos0) # rotate  
		rotpos = rotpos0
		...
		print vertmotpos
		print "Moving Motor to %6.3f mm" % (vertmotpos)
		caput("6bma1:m18",vertmotpos) 
	...
	caput("6bma1:m18",vertmotpos0) # trans         
	while caget("6bma1:m18.DMOV") == 0: 
		time.sleep(0.1)
